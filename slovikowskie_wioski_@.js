...
window.addEventListener(
  ...
  function () {
    const quickbarItemHtml = `
      <li class="quickbar_item">
        <span>
          <a class="quickbar_link" data-hash="slovikowskie-wioski" href="#">
            <img class="quickbar_image" data-src="https://dspl.innogamescdn.com/asset/c1748d3c/graphic//buildings/script.png" alt="" src="https://i.ibb.co/2Yfns8J/20369-16x16x32.png">
            SlovikoweWioski
          </a>
        </span>
      </li>
    ...
    document
      .querySelector('[data-hash="slovikowskie-wioski"]')
      .addEventListener("click", function (e) {
        ...
        async function findVillages(tribeNames, filters) {
          ...
          let tribeData = allyData.filter((tribe) =>
            tribeNames.includes(
              decodeURIComponent(tribe[1].replace(/\+/g, " "))
            )
          );
          ...
          tribeNames.forEach((name) => {
            if (
              !tribeData.find(
                (tribe) =>
                  decodeURIComponent(tribe[1].replace(/\+/g, " ")) === name
              )
            ) {
  ...
  `
        ...
        function autocomplete(input, data) {
          ...
          input.addEventListener("input", function (e) {
            ...
            for (i = 0; i < data.length; i++) {
              if (
                data[i].substr(0, val.length).toUpperCase() ===
                val.toUpperCase()
              ) {
        ...
        autocomplete(
          document.getElementById("inputFields").children[0],
          tribes
        );
        ...
        document
          ...
          .addEventListener("click", () => {
            let inputFields = Array.from(
              document.getElementById("inputFields").children
            );
            ...
            let filters = {
              ...
              pointsMin:
                parseInt(document.getElementById("pointsMin").value) || 0,
              pointsMax:
                parseInt(document.getElementById("pointsMax").value) || 13000,
            };
